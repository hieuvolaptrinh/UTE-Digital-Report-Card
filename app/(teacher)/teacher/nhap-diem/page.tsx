// app/(teacher)/teacher/nhap-diem/page.tsx
"use client";
...
import { GradeEntry } from "@/components/section/teacher/grade-entry";
        ...
        <div className="container mx-auto px-4 py-6 sm:py-8">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold">Nhập điểm</h1>
