...
export const mockUsers: (StudentUser | TeacherUser | ParentUser)[] = [
  ...
  },
  {
    ...
    username: "nguyenthie",
    password: "123456",
    email: "nguyenthie@hcmute.edu.vn",
    name: "Nguyễn Thị E",
    role: "teacher",
    teacherId: "GV002",
    subject: "Văn học",
  ...
  // Parents
  {
    ...
    username: "nguyenvanx",
    password: "123456",
    email: "nguyenvanx@parent.hcmute.edu.vn",
    name: "Nguyễn Văn X",
    role: "parent",
    parentId: "PH001",
    phone: "0923456789",
  ...
  },
  {
    ...
    username: "tranthiy",
    password: "123456",
    email: "tranthiy@parent.hcmute.edu.vn",
    name: "Trần Thị Y",
    role: "parent",
    parentId: "PH002",
    phone: "0923456790",
  ...
  },
  {
    ...
    username: "levanz",
    password: "123456",
    email: "levanz@parent.hcmute.edu.vn",
    name: "Lê Văn Z",
    role: "parent",
    parentId: "PH003",
    phone: "0923456791",
